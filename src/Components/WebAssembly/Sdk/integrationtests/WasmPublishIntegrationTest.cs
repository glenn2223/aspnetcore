...
<PropertyGroup>
    <InvariantGlobalization>true</InvariantGlobalization>
        ...
        public async Task Publish_HostingMultipleBlazorWebApps_Works()
        {
            ...
            // Arrange
            var project = ProjectDirectory.Create("BlazorMultipleApps.Server", "BlazorMultipleApps.FirstClient", "BlazorMultipleApps.SecondClient", "BlazorMultipleApps.Shared");
            var result = await MSBuildProcessManager.DotnetMSBuild(project, "Publish");
